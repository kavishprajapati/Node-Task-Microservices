Feature: Update role 
    ...
    Scenario Outline: Try to update role with invalid details, then it will throw error.
        ...
        When Try to update role of employee with invalid details
        ...
        Examples:
            ...
            | 08c0a174-2e65-49dc-8e86-b79e516150df | admin    |            | "permission" is required  |

    Scenario Outline: Try to update role with valid details
        Given role details roleName:'<roleName>', permission:'<permission>', id:'<id>' to update role successfully
        When  Try to update role of employee with valid details
